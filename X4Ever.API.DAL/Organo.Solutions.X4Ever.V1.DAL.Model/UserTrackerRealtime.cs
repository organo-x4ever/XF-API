...
{
    [Table(name: "x4_user_tracker_realtime", Schema = "x4ever")]
    public class UserTrackerRealtime
    {
        ...
        [Column(name: "total_weight_lost")] public string TotalWeightLost { get; set; }
        ...
        [Column(name: "tracker_start_date")] public DateTime TrackerStartDate { get; set; }
        [Column(name: "tracker_last_date")] public DateTime TrackerLastDate { get; set; }
    }
}