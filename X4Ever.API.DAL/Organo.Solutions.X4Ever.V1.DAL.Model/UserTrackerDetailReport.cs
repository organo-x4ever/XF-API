...
{
    [Table(name: "x4_user_tracker_report_v2", Schema = "x4ever")]
    public class UserTrackerDetailReportV2
    {
        ...
        [Column(name: "tracker_create_date")] public DateTime TrackerCreateDate { get; set; }
    }
}