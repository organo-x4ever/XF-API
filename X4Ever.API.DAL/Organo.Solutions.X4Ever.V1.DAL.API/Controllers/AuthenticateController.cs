...
namespace Organo.Solutions.X4Ever.V1.DAL.API.Controllers
{
    ...
    public class AuthenticateController : ApiController
    {
        ...
        /// </summary>
        public AuthenticateController(UserTokensServices tokenServices, UserServices userServices)
        {
        ...
        public HttpResponseMessage Authenticate()
        {
                ...
                System.Threading.Thread.CurrentPrincipal.Identity.IsAuthenticated)
            {
                ...
                if (basicAuthenticationIdentity != null)
                {
                    ...
                    var user = _userServices.GetUserAuthentication(userId);
                    if (user == null)
                    ...
                    if (string.IsNullOrEmpty(user.UserApplication))
                    {
                        if (!string.IsNullOrEmpty(application))
                        {
                            ...
                            _userServices.Update(ref validationErrors, token.AuthToken, application);
                        }
                    }
        ...
        ///// <returns></returns>
        //[POST("login")]
        //HttpResponseMessage AuthenticateLogin()
        //{
        ...
        //            var userId = basicAuthenticationIdentity.UserId;
        //            var token = _tokenServices.GenerateToken(userId);
        //            var user = _userServices.GetByToken(token.AuthToken, _helper.GetAppSetting("profilePhotoMetaKey"));
        //            if (user == null)
        //                return UnAuthorized();
