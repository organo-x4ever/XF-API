...
namespace Organo.Solutions.X4Ever.V1.DAL.Repository
{
    ...
    public sealed class UnitOfWork : IUnitOfWork
    {
        ...
        private IGenericRepository<UserNotificationSettingsView> _userNotificationSettingsViewRepository;
        ...
        public IGenericRepository<Statistic> StatisticRepository => 
            _statisticRepository??(_statisticRepository=new GenericRepository<Statistic>(_context));

        public IGenericRepository<UserNotificationSettingsView> UserNotificationSettingsViewRepository => 
            _userNotificationSettingsViewRepository ?? (_userNotificationSettingsViewRepository = new GenericRepository<UserNotificationSettingsView>(_context));
